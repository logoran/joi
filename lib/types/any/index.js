...
module.exports = internals.Any = class {
    ...
    _validate(value, state, options, reference) {
        ...
        if (this._invalids.has(value, state, options, this._flags.insensitive)) {
            errors.push(this.createError(value === '' ? 'any.empty' : 'any.invalid', value === '' ? { invalids: this._invalids.values({ stripUndefined: true }) } : { value, invalids: this._invalids.values({ stripUndefined: true }) }, state, options));
